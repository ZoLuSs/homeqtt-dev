                ...
                switch($accessory['accessory_type']){
                    case "light":
                        switch($accessory['accessory_type_detail']){
                            case "simple":
                                echo card_light($accessory['accessory_name'], $accessory['accessory_type_detail'], "lightbulb", $valuesArray["on"], $accessory['accessory_id']);
                        }
                }
            }
        }
...
?>
const socket = io.connect('<?php echo $protocol . $_SERVER['HTTP_HOST']; ?>', {
  query: {token}
});
